\message{ !name(SplineDensity.tex)}%% Based on a TeXnicCenter-Template by Gyorgy SZEIDL.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\message{ !name(SplineDensity.tex) !offset(-3) }
...
\message{ !name(SplineDensity.tex) !offset(-174) }

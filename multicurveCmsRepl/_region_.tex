\message{ !name(multicurveCmsRepl.tex)}%% Based on a TeXnicCenter-Template by Gyorgy SZEIDL.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\message{ !name(multicurveCmsRepl.tex) !offset(-3) }
...
\message{ !name(multicurveCmsRepl.tex) !offset(-163) }

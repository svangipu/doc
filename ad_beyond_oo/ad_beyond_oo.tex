...
\item Penalty: 11.7x\footnote{\tiny different OO tools my show different penalties; for a MinimalWrapper consisting of a double and a native MinimalWrapper - pointer (which is null always), the penalty is around 2.0x}

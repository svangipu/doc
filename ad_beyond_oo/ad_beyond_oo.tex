...
\begin{itemize}
\item compute derivatives by symbolic differentiation of an operation sequence ($+*-/$, $\exp, \sin, ...$) using the chain rule
\item results are exact up to machine precision, also in higher orders

...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \csname LTb\endcsname%
      \put(946,484){\makebox(0,0){\strut{}-3}}%
      \csname LTb\endcsname%
      \put(1922,484){\makebox(0,0){\strut{}-2}}%
      \csname LTb\endcsname%
      \put(2898,484){\makebox(0,0){\strut{}-1}}%
      \csname LTb\endcsname%
      \put(3874,484){\makebox(0,0){\strut{} 0}}%
      \csname LTb\endcsname%
      \put(4851,484){\makebox(0,0){\strut{} 1}}%
      \csname LTb\endcsname%
      \put(5827,484){\makebox(0,0){\strut{} 2}}%
      \csname LTb\endcsname%
      \put(6803,484){\makebox(0,0){\strut{} 3}}%
      \put(176,2739){\rotatebox{-270}{\makebox(0,0){\strut{}P(0,T)/P(t,T)}}}%
      \put(3874,154){\makebox(0,0){\strut{}z}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{CallProbabilities-gnuplottex-fig2}}%
    \gplfronttext
  \end{picture}%
\endgroup
